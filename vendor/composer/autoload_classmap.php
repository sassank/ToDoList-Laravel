...
return array(
    ...
    'GenerateCategories' => $baseDir . '/database/seeds/GenerateCategories.php',
    'GeneratePosts' => $baseDir . '/database/seeds/GeneratePosts.php',
    'GenerateUsers' => $baseDir . '/database/seeds/GenerateUsers.php',
